# CoNET — Document 1 of 3 — Project Overview

*An orchestration and governance layer for private, distributed AI-agent networks*

> Read this first. It explains what CoNET is, the problem it solves, how it differs from adjacent systems, and what v0.1 will and will not do.
...
- [2. What CoNET is (and is not)](#2-what-conet-is-and-is-not)
    - [CoNET is](#conet-is)
    - [CoNET is not](#conet-is-not)
- [3. Prior art and positioning](#3-prior-art-and-positioning)
- [4. Product principles](#4-product-principles)
- [5. Committed decisions (v0.1)](#5-committed-decisions-v01)
- [6. v0.1 scope and success](#6-v01-scope-and-success)
    - [Explicitly deferred](#explicitly-deferred)
- [7. How the document set fits together](#7-how-the-document-set-fits-together)
...
These are settled for v0.1 and shared across all three documents so they never drift:
...
Public/internet discovery; cross-company reputation or marketplace; billing/settlement between organizations; a CoNET-specific public PKI; semantic (embedding-based) Skill discovery; federation between separate CoNET networks; any universal agent-reasoning framework.
...
| LLD-01 … LLD-08 (separate) | Buildable low-level design, one per subsystem. LLD-01 (Manifest & Adapter) is written. |
